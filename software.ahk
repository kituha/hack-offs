...
hwnd := _ImGui_GUICreate("software", 720, 540, (A_ScreenWidth-720)//2, (A_ScreenHeight-540)//2)
winshow, ahk_id %hwnd%
Global rc
...
Loop {
	...
	if !(enable_dont_render & !WinActive("software"))
		settings_gui()
	IsInGame := IsInGame()
...
settings_gui() {
	...
	*/
	...
	if _ImGui_BeginTabItem("WH/RADAR") {
		_ImGui_NewLine()
		_ImGui_Columns(2)
	...
	_ImGui_Columns(1)
	if _ImGui_BeginTabItem("RCS/BHOP/AUTO_PISTOL") {
		_ImGui_NewLine()
		_ImGui_Columns(2)
